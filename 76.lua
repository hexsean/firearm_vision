...
--[[ Before automatic press gun ]] --自动压枪前
...
--[[ Consider all available firearms as an entire list ]] -- 切枪
...
--[[ Switching guns in the same series ]] -- 切枪
...
--[[ Script running status ]] -- 检查脚本是否应处于开启状态, 预计改成当前是否持枪判断
